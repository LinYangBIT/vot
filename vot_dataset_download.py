...
if __name__ == '__main__':
    NAME = 'vot-rgbt2020'
    SAVE_DIR = 'E:/dataset'
    Existed_Seqs = ['afterrain','aftertree','baby','baginhand','baketballwaliking',
    'balancebike','basketball2','bicyclecity','bike','bikeman','bikemove1','biketwo',
    'bluebike', 'blueCar', 'bus6', 'car', 'car10', 'car20', 'car3', 'car37', 'car41',]
